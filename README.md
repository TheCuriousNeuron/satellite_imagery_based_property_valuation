...
1. Downloading images using data_fetcher.py:
...
2. Preprocessing the data using preprocessing.ipynb:
Enter the csv file path that contains your data. Run each cell one by one. This notebook not only analyses the existing data but all engineers new features that give better results in prediction. New data file gets saved.
